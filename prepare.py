...
/* exploders */
#const STORM01 1056    /* falcon */ /* 0.25 food per sec */
#const STORM02 1028   /* stork */  /* 0.25 food per sec */
#const STORM03 816   /* macaw */ /* 0.25 food per sec */
...
/* {waves[0][minutes]} min */
	effect_amount SET_ATTRIBUTE COUNTDOWN01 ATTR_DEAD_ID 1056
...
/* {waves[2][minutes]} min */
	effect_amount SET_ATTRIBUTE COUNTDOWN03 ATTR_DEAD_ID 816
...
/* {waves[0][minutes]} min 1 dmg */
	...
	effect_amount SET_ATTRIBUTE EXPLODER1 ATTR_MAX_RANGE 2
	effect_amount SET_ATTRIBUTE EXPLODER1 ATTR_LINE_OF_SIGHT 0
	effect_amount SET_ATTRIBUTE EXPLODER1 ATTR_ATTACK 0
	effect_amount SET_ATTRIBUTE EXPLODER1 ATTR_ATTACK 271
	effect_amount SET_ATTRIBUTE EXPLODER1 ATTR_ATTACK 512
	effect_amount SET_ATTRIBUTE EXPLODER1 ATTR_ATTACK 769
	effect_amount SET_ATTRIBUTE EXPLODER1 ATTR_ATTACK 1024
	effect_amount SET_ATTRIBUTE EXPLODER1 ATTR_ATTACK 1280
	effect_amount SET_ATTRIBUTE EXPLODER1 ATTR_GARRISON_ARROWS 1
	effect_amount SET_ATTRIBUTE EXPLODER1 ATTR_MAX_DUP_MISSILES 1
	effect_amount SET_ATTRIBUTE EXPLODER1 ATTR_BLAST_LEVEL 2
	effect_amount SET_ATTRIBUTE EXPLODER1 ATTR_CREATION_TIME 0
	effect_amount SET_ATTRIBUTE EXPLODER1 ATTR_ACCURACY_PERCENT 100
	effect_amount SET_ATTRIBUTE EXPLODER1 ATTR_PROJECTILE_ID -1
...
/* {waves[1][minutes]} min 1 dmg */
	...
	effect_amount SET_ATTRIBUTE EXPLODER2 ATTR_MAX_RANGE 1
	effect_amount SET_ATTRIBUTE EXPLODER2 ATTR_LINE_OF_SIGHT 0
	effect_amount SET_ATTRIBUTE EXPLODER2 ATTR_ATTACK 15
	effect_amount SET_ATTRIBUTE EXPLODER2 ATTR_ATTACK 256
	effect_amount SET_ATTRIBUTE EXPLODER2 ATTR_ATTACK 513
	effect_amount SET_ATTRIBUTE EXPLODER2 ATTR_ATTACK 768
	effect_amount SET_ATTRIBUTE EXPLODER2 ATTR_ATTACK 1024
	effect_amount SET_ATTRIBUTE EXPLODER2 ATTR_CREATION_TIME 0
	effect_amount SET_ATTRIBUTE EXPLODER2 ATTR_BLAST_LEVEL 2
...
/* {waves[2][minutes]} min 1 dmg */
	...
	effect_amount SET_ATTRIBUTE EXPLODER3 ATTR_MAX_RANGE 1
	effect_amount SET_ATTRIBUTE EXPLODER3 ATTR_LINE_OF_SIGHT 0
	effect_amount SET_ATTRIBUTE EXPLODER3 ATTR_ATTACK 15
	effect_amount SET_ATTRIBUTE EXPLODER3 ATTR_ATTACK 256
	effect_amount SET_ATTRIBUTE EXPLODER3 ATTR_ATTACK 513
	effect_amount SET_ATTRIBUTE EXPLODER3 ATTR_ATTACK 768
	effect_amount SET_ATTRIBUTE EXPLODER3 ATTR_ATTACK 1024
	effect_amount SET_ATTRIBUTE EXPLODER3 ATTR_CREATION_TIME 0
	effect_amount SET_ATTRIBUTE EXPLODER3 ATTR_BLAST_LEVEL 2
	effect_amount SET_ATTRIBUTE EXPLODER3 ATTR_BLAST_RADIUS {waves[2][radius]}
	effect_amount SET_ATTRIBUTE EXPLODER3 ATTR_DEAD_ID 816
